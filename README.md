...
- Geteilten Ordner (`~/media`) vom Server akzeptieren wenn er erscheint
...
Bilder unter `~/medienbasis/` (Pi) ablegen.  
Sie erscheinen automatisch alle **5 Bilder** in jeder Diashow.  
Konfigurierbar: `GRUNDSTOCK_INTERVAL` in `mediaplayer_app.py` (0 = deaktiviert).
